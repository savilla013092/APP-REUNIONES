...
const sampleActas: Omit<Acta, "id">[] = [
    {
        ...
        generatedContent: {
            introduction: "El dia 20 de enero de 2026, siendo las 10:00 horas, se llevo a cabo la reunion de planificacion del primer trimestre en la Sala de Conferencias A, con la asistencia de los miembros del equipo de desarrollo.",
            development: "Durante la sesion se revisaron los objetivos estrategicos definidos para el Q1 2026. Se analizo la disponibilidad de recursos humanos y tecnologicos, estableciendo prioridades para cada iniciativa. El equipo acordo un cronograma tentativo de entregas que sera revisado semanalmente.",
            agreements: [
            ...
            closure: "Sin mas asuntos que tratar, se dio por finalizada la reunion a las 11:30 horas, comprometiendose los asistentes a cumplir con las tareas asignadas.",
        },
...
export const initializeDemoData = (): void => {
    ...
    if (needsInit) {
        ...
        console.log("Demo data initialized (version " + DATA_VERSION + "):", actasWithIds.length, "actas");
    }
};
