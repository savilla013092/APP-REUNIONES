...
export const sendSignatureRequests = async (
    ...
    const sendSignatureRequestsFn = httpsCallable<
        SendSignatureRequestsData,
        SendSignatureResult
    >(functions, "sendSignatureRequests");
...
export const recordSignature = async (
    ...
    // Production mode: use Cloud Function
    const recordSignatureFn = httpsCallable<
        RecordSignatureData,
        RecordSignatureResult
    >(functions, "recordSignature");
