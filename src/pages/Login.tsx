                    ...
                    {!isFirebaseConfigured && (
                        <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                            <p className="text-xs text-amber-800">
                                <strong>Modo Demo:</strong> Los datos se guardan localmente en tu navegador.
                                Para usar Firebase, configura las variables en <code className="bg-amber-100 px-1 rounded">.env.local</code>
                            </p>
                        </div>
                    )}
                </CardContent>
