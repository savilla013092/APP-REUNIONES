...
export default function Dashboard() {
  ...
  const stats = [
    ...
    {
      label: 'Pendientes',
      value: actas.filter(a => a.status !== 'completed').length,
      icon: Clock,
    ...
    <div className="min-h-screen bg-slate-50/50 flex">
      ...
      <aside className="hidden lg:flex w-64 bg-white border-r flex-col p-6 space-y-8">
        ...
        <nav className="space-y-1">
          <Button
            variant="ghost"
            className="w-full justify-start gap-3 bg-primary/5 text-primary font-semibold"
          >
              ...
              <div className="p-20 text-center space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-slate-500 text-sm">
                    Empieza por crear la primera acta de tu organización.
                  </p>
                </div>
                ...
                {filteredActas.map(acta => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-3 px-1 sm:px-0">
                      <Badge
                        variant={acta.status === 'completed' ? 'default' : 'secondary'}
                        className="px-2.5 py-0.5 font-medium border-none"
                      >
