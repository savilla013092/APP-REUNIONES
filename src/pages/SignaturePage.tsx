        ...
        try {
            ...
            if (attendeeId) {
                ...
                if (found) {
                    ...
                    if (!shouldUseDemoMode() && token && found.signatureToken && found.signatureToken !== token) {
            ...
            <div className="h-screen flex items-center justify-center p-6 bg-slate-50">
                <Card className="max-w-md w-full text-center p-8 space-y-4">
                    ...
                    <p className="text-slate-500">
                        El enlace de firma que has utilizado no es valido o ha expirado.
                        Contacta al organizador de la reunion para recibir un nuevo enlace.
                    </p>
                </Card>
            </div>
        );
        ...
        return (
            <div className="h-screen flex items-center justify-center p-6 bg-slate-50">
                <Card className="max-w-md w-full text-center p-8 space-y-4">
                    ...
                    <p className="text-slate-500">
                        Muchas gracias, <strong>{attendee.name}</strong>. Tu firma ha sido vinculada al acta de la reunion:
                    </p>
                    <p className="font-semibold text-slate-700">{acta.meetingInfo.title}</p>
        ...
        <div className="min-h-screen bg-slate-50 py-12 px-6">
            <div className="max-w-2xl mx-auto space-y-8">
                <div className="text-center space-y-2">
                    ...
                    <p className="text-slate-500">
                        Estas por firmar el acta: <span className="font-semibold">{acta.meetingInfo.title}</span>
                    </p>
                </div>
                ...
                <Card className="border-slate-200 shadow-xl overflow-hidden">
                    ...
                    <CardFooter className="bg-slate-50 p-6 flex justify-between border-t gap-4">
                        <Button variant="ghost" onClick={clear} className="gap-2 text-slate-500 hover:text-destructive">
                ...
                <p className="text-center text-xs text-slate-400">
                    Al confirmar, aceptas que esta firma digital tiene validez para este documento especifico bajo las politicas de tu organizacion.
                </p>
            </div>
        </div>
    );
